#Breakout game made in pygame used to train the populations. Returns the score as a the fitness with a 1000 point bonus on game completion
...
class Breakout():
    ...
    def main(self, w):
        ...
        while 1:
            ...
            if timeElapsed > 7200: # 7200 frames or 2 minutes at 60 frames per second
                f = open("fit.txt", "w")
                f.write(str(score))
                f.close()
