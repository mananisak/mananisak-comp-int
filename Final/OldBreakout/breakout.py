...
class Breakout():
    ...
    def ANN(self, weights, inputs):
        ...
        for j in range(len(hiddenOut)):
            ...
            hiddenOut[j] = self.activation(int(x + (threshold * weights[j][5]))) # Or some other activation function
        ...
        for j in range(len(finalOut)):
            ...
            finalOut[j] = self.activation(int(x + (threshold * weights[j+5][5]))) # Or some other activation function
    ...
    def main(self, w):
        ...
        while 1:
            ...
            move_left, move_right, bat_speed = outputList[0], outputList[1], outputList[2]
